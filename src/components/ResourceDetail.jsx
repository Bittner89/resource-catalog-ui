...
const ResourceDetail = ({ resource }) => {
    ...
    const { id, title, type, description, authorId, createdAt, avarageRating, feedback } = resource;
    ...
    return (
        <div className="bg-white p-8 rounded-2xl shadow-lg">
            <button className="text-accent-light hover:underline mb-6 flex items-center transition-colors">
                ...
                Zurück zur Liste allen Ressourcen
            </button>
            ...
            <div className="border-t border-gray-200 pt-8 mt-8 text-gray-600 text-sm grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {avarageRating && (
                    <p className="flex items-center">
                        ...
                        <span className="font-medium text-gray-700">{avarageRating.toFixed(1)} / 5</span>
                    </p>
                )}
